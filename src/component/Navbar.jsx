...
export default function Navbar(){
    ...
    return(
        <nav className={`${theme} fixed top-0 right-0 ${menuClick && "h-[100dvh]"} left-0 z-50 backdrop-blur-2xl dark:bg-slate-transparent bg-transparent ${lang =="Ar"? "font-[ArabicFont]":"font-[LatinFont]"} border-b-4 dark:border-indigo-300 border-slate-700 grid grid-cols-6 ${menuClick && "grid-rows-3"} items-center py-4`}>
